...
public class maximumTest {
    @Test
    public void findMaxFromThreeIntegersValues() {
        Integer Int1 = 10, Int2 = 12, Int3 = 7;
        Integer intMax = Operation.testMaximum(Int1, Int2, Int3);
        Assertions.assertEquals(12, intMax);
    }
    @Test
    public void findMaxFromThreeFloatValues() {
        ...
        Assertions.assertEquals(19.3f, floatMax);
    }
    @Test
    public void findMaxFromThreeStringValues() {
        String xString = "Cherry", yString = "Banana", zString = "Apple";
        String stringMax = Operation.testMaximum(xString, yString, zString);
        Assertions.assertEquals("Cherry", xString);
    }
}